...
{
	m_transform.pos = { 0.0f,0.0f,0.0f };    // 初期位置
...
void CModel::Draw(void)
{
	...
	m_transform.SetMatrix(); // Transformのマトリックスを設定
...
void CModel::SetParent(const Index idxParent) { m_pParent = CModelManager::GetInstance().GetModel(idxParent); }
