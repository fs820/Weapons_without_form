...
// 公開
public:
	CModel(const model::Source* pSource) : m_pSource(pSource), m_pParent{}, m_offSet{}, m_transform{} {}
	~CModel() = default;
...
private:
	...
	const CModel* m_pParent;              // 親モデルのポインタ
	WriteOnce<DirectX::Vector3> m_offSet; // オフセット
